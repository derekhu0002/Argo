...
### Evidence
- 工作区范围：d:\Projects\Argo
- 意图架构图谱：d:\Projects\Argo\design\KG\SystemArchitecture.json
- 图谱 Schema：d:\Projects\Argo\.github\argoschema\SystemArchitecture.schema.json
...
- 测试目录：d:\Projects\Argo\tests
- 源码目录：d:\Projects\Argo\src
...
### Operational Rules
1. 分析范围仅限当前工作区 d:\Projects\Argo。先读取意图架构，再读取已有实现架构契约（若存在），再按需读取代码、测试、脚本、配置与文档。凡是能从仓库和工具结果确认的事实，不要向用户追问。
