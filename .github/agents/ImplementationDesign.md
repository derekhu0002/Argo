...
16. 不要宣称本阶段可交接给 Coding/Repair，除非 design/KG/ImplementationToCodingHandoff.json 已写出并且 `unified argo MCP tool validateStageHandoff with stage implementation-to-coding` 可以通过；若仍未通过，必须明确阻塞点。
