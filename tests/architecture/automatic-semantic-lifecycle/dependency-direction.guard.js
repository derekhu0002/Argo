...
// GIVEN the approved BP-AUTOALIGN successor scope
...
assert.deepStrictEqual(
  [...targetPaths].sort(),
  [...allowedTargets].sort(),
  'SEMANTIC_LIFECYCLE_TARGET_SET_NOT_AUTHORITATIVE_BP_SCOPE',
);
...
assert(
  ...
  'SEMANTIC_LIFECYCLE_WRITE_LIFECYCLE_NOT_AUTHORIZED',
);
assert(
  targetPaths.includes('.argo/scripts/graph-rag/defaultSemanticRetrieval.js'),
  'SEMANTIC_LIFECYCLE_QUERY_RECOVERY_NOT_AUTHORIZED',
);
assert(
