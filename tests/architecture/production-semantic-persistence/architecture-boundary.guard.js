...
for (const required of [
  ...
  'createProductionSemanticNeo4jAdapter(dependencies)',
  'createProductionSemanticCheckpointStore(dependencies)',
  ...
  'delete tombstones',
  'exactly `upsertRecords`, `deleteTombstones`, `readRecords`, and `close`',
  'no `runId`',
