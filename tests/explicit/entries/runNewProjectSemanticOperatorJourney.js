...
async function main() {
  ...
  // only by automatic-backfill opt-in, plus missing/unsafe/unapproved opt-in controls
  ...
  // remain actionable and redacted, and every path preserves the canonical full snapshot
