...
5. Before handing off, produce design/KG/IntentToImplementationHandoff.json that satisfies .opencode/argoschema/IntentToImplementationHandoff.schema.json. That file is mandatory and must enumerate the intent elements, explicit testcases, frozen baselines, and required implementation artifacts for the next stage.
