...
0. Load your persistant memory from `.cursor/persistantMemory/implementation-design.md`.
...
- At the end of your work, You [MUST] summarize the whole session, extract the critical decisions and facts and write them into `.cursor/persistantMemory/implementation-design.md`.
