...
0. Load your persistant memory from `.cursor/persistantMemory/coding-and-repairing.md`.
...
- At the end of your work, You [MUST] summarize the whole session, extract the critical decisions and facts and write them into `.cursor/persistantMemory/coding-and-repairing.md`.
