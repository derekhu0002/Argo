...
23. DT-19 capacity evidence begins after real DT-18 quality evidence and remains evidence-only. It is complete only when phase-1 result ids or result cardinality and measured precision are preserved from actual quality observations for every declared purpose, while missing quality evidence blocks explicitly and cap, budget, pagination, truncation, continuation, top-k, token-budget, result-limit, and capacity-policy decisions remain absent. DT-19 does not authorize capacity governance implementation or a release rule.
