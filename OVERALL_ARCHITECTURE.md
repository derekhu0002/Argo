...
23. DT-19 capacity evidence begins after W7 quality evidence and remains evidence-only. It is complete only when phase-1 result cardinality and measured precision are recorded for every declared purpose, while cap, budget, pagination, truncation, continuation, top-k, token-budget, result-limit, and capacity-policy decisions remain absent. DT-19 does not authorize capacity governance implementation or a release rule.
