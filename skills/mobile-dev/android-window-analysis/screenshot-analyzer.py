...
Options:
    ...
    --assert-color-at-bounds L,T,R,B #HEX [tolerance]  Crop+check color at layout bounds
    --check-image-shape L,T,R,B   Analyze corner pixels to detect CIRCLE/ROUNDED/SQUARE
    --compare-region-color L,T,R,B OTHER.png LABEL  Compare region mean color with another screenshot
